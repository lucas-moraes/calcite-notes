...
Transform.prototype;
function GraphView({ nodes, links, onNodeClick, activeNodeId }) {
  ...
  reactExports.useEffect(() => {
    ...
    const simulation$1 = simulation(nodes).force("link", link(links).id((d) => d.id).distance(100)).force("charge", manyBody().strength(-150)).force("center", center(width / 2, height / 2)).force("x", x(width / 2).strength(0.05)).force("y", y(height / 2).strength(0.05));
    const link$1 = svg.append("g").selectAll("line").data(links).join("line").attr("stroke", "#3f4248").attr("stroke-opacity", 0.6).attr("stroke-width", 1);
    const node = svg.append("g").selectAll("g").data(nodes).join("g").attr("class", "cursor-pointer").call(drag().on("start", dragstarted).on("drag", dragged).on("end", dragended)).on("click", (event, d) => onNodeClick(d.id));
    node.append("circle").attr("r", (d) => d.id === activeNodeId ? 6 : 4).attr("fill", (d) => d.id === activeNodeId ? "#7c4dff" : "#6b7280").attr("stroke", "#0d0d0f").attr("stroke-width", 1.5).attr("class", "transition-all duration-300");
    node.append("text").attr("dx", 10).attr("dy", 4).text((d) => d.name).attr("fill", (d) => d.id === activeNodeId ? "#ffffff" : "#9ca3af").attr("font-size", "10px").attr("class", "pointer-events-none select-none");
    ...
    const resizeObserver = new ResizeObserver(() => {
      ...
      simulation$1.force("center", center(w / 2, h / 2));
      simulation$1.alpha(0.3).restart();
    });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full bg-base-950 relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "svg",
    {
      ref: svgRef,
  ...
  "svg",
  {
    ...
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          fill: "#01020B",
          d: "M1 65V1c25.02 0 50.042 0 75.388.31-1.88 2.814-4.42 5.395-2.127 8.971 2.429 3.789 5.665 3.865 9.929 2.427C90.114 10.71 96.062 9.043 101 5c0 19.688 0 39.375-.42 59.527-4.417.467-8.415.469-12.579.142-2.4-4.814-4.635-9.301-6.923-14.141-3.342-5.445-6.631-10.536-10.008-15.862-.364-.4-.642-.564-.977-1.083a288.67 288.67 0 0 0-8.052-11.728c-.061.055.048.176.033-.154a8.069 8.069 0 0 0-1.02-1.8c.003.06.12.051.053-.253-.38-.777-.695-1.25-1.148-2.037-3.081-4.365-6.024-8.416-9.31-12.53-.808.568-1.275 1.2-2.051 1.97-2.456 3.382-4.602 6.626-7.051 10.018-2.691 3.418-5.08 6.688-7.834 9.986-6.832 1.788-11.84 9.386-20.022 4.263l-.447 1.176c3.616 3.514 7.233 7.029 10.769 10.897-1.766 4.757-3.45 9.16-5.369 13.654-.62.406-1.006.72-1.775 1.049-2.248.918-4.706 1.357-5.858 2.823C8.321 64.338 4.898 65.029 1 65z"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          fill: "#040711",
          d: "M88.167 64.998c3.998-.002 7.996-.004 12.414-.002.419 10.31.419 20.615.419 30.962H1v-30.49c3.898-.439 7.321-1.13 10.011-4.551 1.152-1.466 3.61-1.905 5.743-2.479-2.438 6.758-5.145 13.186-7.933 19.936-1.278 2.407-2.472 4.49-3.707 6.964 2.65 4.675 7.333 2.239 11.125 3.942 4.596 1.066 8.924 2.021 13.303 2.521 3.46.395 6.983.232 10.881.43 8.458-.051 16.513-.218 24.982-.324a56.955 56.955 0 0 0 4.986-.158c6.218-.64 12.073-.96 17.84-1.85 2.957-.457 5.756-1.935 8.676-3.313-1.22-3.108-2.49-5.855-3.81-8.98-1.676-4.456-3.303-8.532-4.93-12.608z"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          fill: "#000410",
          d: "M101 4.5c-4.938 4.543-10.886 6.21-16.81 8.208-4.264 1.438-7.5 1.362-9.929-2.427-2.292-3.576.248-6.157 2.596-8.97 7.31-.311 14.49-.044 21.636-.434C101.647.705 100.952 2.346 101 4.5z"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          fill: "
"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          fill: "#CF8E2C",
          d: "M36.006 47.158c-.625 1.116-1.25 2.231-2.404 3.645-3.198.945-5.867 1.59-8.536 2.237-.002-.774-.004-1.547.036-2.706 2.049-3.474 4.078-6.548 6.051-9.658 1.124-1.77 2.157-3.6 3.532-5.555 1.414.478 2.526 1.11 3.952 1.816-.35 2.835-1.016 5.596-1.657 8.764.024.407-.014.318-.165.475-.37.432-.59.707-.809.982z"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          fill: "#C17012",
          d: "M66.779 51.138c3.128.277 6.257.554 9.807.835a7.48 7.48 0 0 1 1.173.132c.25.445.25.842.253 1.538A279.978 279.978 0 0 1 73.61 65.63c-.241.4-.662.37-.71.004-2.072-5.076-4.097-9.786-6.121-14.496z"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          fill: "#E08E29",
          d: "M26.07 67.963a1029.58 1029.58 0 0 1-6.9-3.843c.042-1.291.376-2.397 1.136-3.93.838-1.032 1.25-1.635 1.66-2.238.808-.903 1.616-1.806 2.699-2.445.651 4.328 1.028 8.392 1.405 12.456z"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          fill: "#DC801F",
          d: "M21.644 57.945c-.089.61-.5 1.213-1.165 1.937-.309-.314-.363-.75-.431-1.515.415-.362.844-.396 1.596-.422z"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          fill: "#E9AF4B",
          d: "M26.29 68.099c-.597-4.2-.974-8.264-1.372-12.762.01-.85.044-1.264.112-1.988 2.705-.955 5.374-1.601 8.417-2.264.374-.017.428.42.149.875-2 6.015-3.719 11.575-5.507 17.101-.07-.033-.21-.092-.21-.092-.457-.245-.913-.49-1.589-.87z"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          fill: "#BA5F08",
          d: "m72.948 66 .63.046c1.506 4.106 2.804 8.195 4.238 12.628-2.255.062-4.648-.219-7.428-.582-1.521-.381-2.655-.679-4.043-1.39 1.446-3.507 3.146-6.599 5.076-9.795.663-.372 1.095-.64 1.527-.907z"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          fill: "#511F03",
          d: "M71.19 67.011c-1.7 3.092-3.4 6.184-5.189 9.615-6.106 1.053-12.123 1.768-18.585 2.556-1.811.057-3.177.04-5.152-.246-5.183-2.416-9.758-4.563-14.332-6.71-.172-.05-.344-.1-.777-.214.02-.85.303-1.635.654-2.732.07-.31.21-.252.605-.307 3.792-3.08 7.19-6.104 10.59-9.128 7.374-.295 14.748-.59 22.754-.622 3.565 2.771 6.499 5.28 9.432 7.788z"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          fill: "#A03F0D",
          d: "M27.982 72.59c4.524 1.783 9.099 3.93 13.873 6.38-2.35 3.325-4.898 6.347-7.59 9.657-.345.281-.55.274-1.059.23-1.928-5.325-3.551-10.614-5.224-16.267z"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          fill: "#813B08",
          d: "M71.421 66.907c-3.164-2.404-6.098-4.913-9.22-7.701 1.002-2.769 2.191-5.257 3.614-7.997.233-.253.598-.158.781-.115 2.207 4.754 4.232 9.464 6.304 14.54-.384.634-.816.901-1.479 1.273z"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          fill: "#813B09",
          d: "M38.968 59.496c-3.363 3.373-6.762 6.397-10.485 9.51 1.394-5.471 3.114-11.03 5.108-16.826 1.964 2.166 3.653 4.567 5.377 7.316z"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          fill: "#E5B64B",
          d: "M36.253 47.034c-.027-.151.192-.426.606-.88.01.133-.175.445-.606.88z"
        }
      )
    ]
  }
...
function App() {
  const [notes, setNotes] = reactExports.useState([defaultNote]);
  const [activeNoteId, setActiveNoteId] = reactExports.useState("welcome");
