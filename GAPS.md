# GAPS.md — Recursos do Obsidian que calcite-notes não tem
...
- **Plugin system** — ecossistema gigante de plugins da comunidade. Esta é a maior lacuna
- **CSS snippets** — temas customizados por CSS do usuário
- **Command palette customizável** — comandos podem ser removidos/reordenados
...
- **Vim key bindings** nativos
- **Focus mode / Typewriter mode**
- **Workspaces** — salvar/restaurar layout completo
- **File recovery / version history** — snapshots automáticos
- **Audio recorder** — gravação direta no app

## Outros

- **Obsidian Sync / Publish** — sync pago e publicação
- **Importer** — migração de Evernote, Notion, Roam, etc.
- **Mobile app** — iOS/Android nativos
